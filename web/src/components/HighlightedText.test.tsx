...
describe("HighlightedText", () => {
  ...
  describe("基本レンダリング", () => {
    ...
    it("ハイライトなしセグメントが通常テキストとして描画される", () => {
      const segments: TextSegment[] = [{ text: "plain text", highlight: null }];
  ...
  describe("エッジケース", () => {
    ...
    it("改行を含むテキストが保持される", () => {
      const segments: TextSegment[] = [{ text: "line1\nline2\nline3", highlight: null }];
      const { container } = render(<HighlightedText segments={segments} />);
      ...
      const segments: TextSegment[] = [
        {
          ...
          highlight: {
            ...
            diffItem: {
              ...
              path: "x",
              sourceValue: null,
              targetValue: "added-text",
            },
          },
        },
      ];
      const { container } = render(<HighlightedText segments={segments} />);
      const addedSpan = container.querySelector(
